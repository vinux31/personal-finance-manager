...
- [x] **Phase 7: UI/Data Consistency** — Goals total view, atomic seed, timezone ESLint rule, UX-01 + UX-02 fixes (migrations 0022-0024) — shipped 2026-04-29 (PASS-WITH-NOTES)
- [x] **Phase 8: Dev Hygiene** — Recharts type cleanup, seed.sql config, perf doc note (no DB changes) — shipped (PASS)
- [x] **Phase 9: QA Bug Fix** — Fix 8 bug dari QA-FINDINGS.md (2 Critical DB + 4 Medium frontend + 2 Low a11y/i18n) — shipped 2026-05-01 (PASS)
...
| 8. Dev Hygiene | v1.1 | 2/2 | ✅ Complete | (shipped pre-Phase-9) |
